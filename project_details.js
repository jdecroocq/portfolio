...
async function updateProjectNavigation() {
  ...
  const prevProjectId = projectFolders[currentIndex - 1]
    ? projectFolders[currentIndex - 1].id
    : projectFolders[projectFolders.length - 1].id;
  const nextProjectId = projectFolders[currentIndex + 1]
    ? projectFolders[currentIndex + 1].id
    : projectFolders[0].id;
  const prevProjectName = projectFolders[currentIndex - 1]
    ? projectFolders[currentIndex - 1].name
    : projectFolders[projectFolders.length - 1].name;
  const nextProjectName = projectFolders[currentIndex + 1]
    ? projectFolders[currentIndex + 1].name
